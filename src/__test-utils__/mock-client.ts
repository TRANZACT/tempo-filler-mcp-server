...
export function createMockWorklogUpdater(overrides?: Partial<WorklogUpdater>): WorklogUpdater {
  return {
    updateWorklog: async (_worklogId: string, _payload: TempoWorklogCreatePayload): Promise<TempoWorklogResponse> => ({
      id: "99",
      tempoWorklogId: 99,
      billableSeconds: 28800,
      timeSpentSeconds: 28800,
